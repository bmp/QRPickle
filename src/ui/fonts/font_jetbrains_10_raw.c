 ...
 * Size: 10 px
 * Bpp: 4
 * Opts: --no-compress --no-prefilter --bpp 4 --size 10 --font assets/fonts/JetBrainsMono-Bold.ttf -r 0x20-0x7F --format lvgl -o src/ui/fonts/font_jetbrains_10_raw.c
 ******************************************************************************/
...
#ifndef FONT_JETBRAINS_10_RAW
#define FONT_JETBRAINS_10_RAW 1
#endif

#if FONT_JETBRAINS_10_RAW
...
#if LVGL_VERSION_MAJOR >= 8
const lv_font_t font_jetbrains_10_raw = {
#else
lv_font_t font_jetbrains_10_raw = {
#endif
...
#endif /*#if FONT_JETBRAINS_10_RAW*/
